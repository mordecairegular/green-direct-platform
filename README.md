...
> 2026-05-19 更新：本项目已从“V0.1 风光储批量技术测算工具”升级规划为“绿电直连 / 微电网项目方案策划与推荐平台”。本 README 中的 V0.1 内容仍作为技术基线和历史开发资料保留；后续 Codex / Claude Code 开发请优先阅读 `AGENTS.md`、`CLAUDE.md` 和 `notes/architecture_reframe_20260519/`。
