...
def build_daily_balance_chart(hourly: pd.DataFrame, mode: str = "首日", selected_date=None) -> ChartResult:
    ...
    fig.update_yaxes(title_text="万千瓦", tickformat=",.2f", row=1, col=1)
    fig.update_yaxes(title_text="万千瓦", tickformat=",.2f", row=2, col=1)
    fig.update_yaxes(title_text="SOC", tickformat=".1%", row=3, col=1)
