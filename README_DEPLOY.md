...
仓库已提供 `render.yaml`，可在 Render 中用 Blueprint 创建服务；当前 pilot 配置显式部署 `codex/UI` 分支，并设置为 GitHub Actions 质量门通过后再自动部署。详细步骤见 `docs/MANAGED_PUBLIC_BETA_DEPLOYMENT.md`。
